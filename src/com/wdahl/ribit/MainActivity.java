	...
	protected DialogInterface.OnClickListener mDialogListener = new OnClickListener() {
		...
		private void takePicture() {
			...
			if (mMediaUri == null ){
				...
				Toast.makeText(MainActivity.this, 
						R.string.external_storage_not_found, 
		...
		private void takeVideo() {
			...
			if (mMediaUri == null ){
				...
				takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, mMediaUri);
				takePhotoIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 10);
				takePhotoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 0); // 0 = lowest quality
				startActivityForResult(takePhotoIntent, TAKE_VIDEO_REQUEST);
			}
		}
